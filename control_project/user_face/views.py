...
from .forms import UserForm, UserDeleteForm, ProjectForm, ProjectFormDeleteForm
from .models import Person, User, Project
        ...
        if 'form2_submit' in request.POST:
            ...
            if form2.is_valid():
                ...
                try:
                    ...
                    form2.add_error('id_project', 'Проект с указанным ID не найден')
    else:
        from1 = ProjectForm()
        form2 = ProjectFormDeleteForm()

    existing_projects = Project.objects.all()
    return render(request, 'user_face/add_project.html', {'form1': form1, 'form2': form2, 'existing_projects': existing_projects})
